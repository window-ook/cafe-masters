...
export const TOAST_SUCCESS = {
    ...
    UPDATE_COLLECTION: '수집한 카페의 정보를 수정했습니다!',
...
export const TOAST_ERROR = {
    ...
    CREATE_BOOKMARK: '북마크 추가에 실패했습니다',
    DELETE_BOOKMARK: '북마크 제거에 실패했습니다',
    ...
    DELETE_RECOMMENDATION: '추천 카페 삭제에 실패했습니다',
