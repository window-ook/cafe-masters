...
카페 마스터즈는 세상의 카페러버들을 위해 만든 앱인 것이에오.. <br />
전국에 있는 카페를 검색할 수 있고, 내가 갔던 카페에 대해 메모할 수 있는데 <br />
그냥 메모하면 재미가 없잖아요? 이걸 카드로 수집할 수 있어요! <br />
카드를 수집할 때마다 티어도 올라가고, 특정 카페는 유니크 카드를 주기도 합니다. 잘 찾아보세요😊
...
카페 마스터즈를 이용하기 위해서는 로그인이 필수입니다.<br/>

<!-- 이메일 회원가입 시 정보 입력 webp -->
<!-- 인증번호 입력 webp -->

이메일로 회원가입하거나 카카오 계정으로 로그인이 가능해요!<br/>
이메일로 가입시 해당 이메일로 발송된 인증번호 6자리를 확인하고 똑같이 입력해주세요.<br/>
가입이 완료되면 자동으로 로그인이 됩니다.<br/>
