...
export default function CafeItem({
  ...
  return (
    <li
      className={`h-24 p-2 rounded-xl shadow-md list-none ${isDarkTheme ? 'bg-dark-background text-white shadow-dark-shadow' : ''} hover:shadow-main-300 transition duration-200 ease`}
    >
      <button
        type="button"
