...
import CollectedCafeDetail from '@/components/collection/CollectedCafeDetail';
import BookmarkedCafeDetail from '@/components/bookmark/BookmarkedCafeDetail';
import RecommendedCafeDetail from '@/components/recommendation/RecommendedCafeDetail';
